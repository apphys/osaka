...
class ModelAgnosticMetaLearning(object):
    ...
    def observe_base(self, batch):
        ...
        return inputs, targets, task_switch, mode, ways, shots, N, K, results

    def _compute_l0(self, inputs, targets, results):
    ...
    def observe(self, batch):
        ...
        Legend for shorthand:
            ...
            K: num shots
        """
        inputs, targets, task_switch, mode, ways, shots, N, K, results = \
            self.observe_base(batch)
