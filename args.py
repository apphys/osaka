...
def parse_args():
    ...
    group.add_argument('--um_power', type=float, default=0.0, help="The power for update modulation.")
    group.add_argument('--observe_fn', type=str, default='observe', help="With method to use for observe.")
